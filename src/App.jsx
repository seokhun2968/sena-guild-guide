...
const allHeroes = [
  ...
  "브란즈&브란셀", "오르카","여포", "란드그리드", "연희", "스쿨드", "실베스타", "바네사", "멜키르", "키리엘",
  "프레이야", "린", "레긴레이프", "성진우", "오목", "루디", "아킬라", "라드그리드", "클레미스", "플라튼",
  "비스킷", "크리스", "아일린", "레이첼", "제이브", "스파이크", "엘리시아", "트루드", "카르마",
  "팔라누스", "손오공", "아리스","미스트", "오를리", "나타", "에이스", "클라한", "세인",
...
const pets = ["루", "유", "이린", "연지", "카람", "멜패로", "리첼", "요랑", "제오", "파이크", "크리", "윈디"];
